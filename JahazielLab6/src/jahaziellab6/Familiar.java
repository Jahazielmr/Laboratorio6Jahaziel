...
public class Familiar extends Persona{
    ...
    public Familiar(Familiar familiar_padre, int edad, String nombre, String colorPiel, String ID, String Nacionalidad, String Lugar_Nacimiento, DefaultTreeModel arbo_genealogico, Familiar familiar) {
